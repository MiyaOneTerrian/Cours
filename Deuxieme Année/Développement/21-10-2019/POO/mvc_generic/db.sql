...
CREATE VIEW contrats AS (
  SELECT e.nom, e.prenom, a.datedebut, a.datefin, a.typecontrat, ets.nom AS entreprise
  FROM etudiant e, alternance a, entreprise ets
  WHERE e.idetudiant = a.idetudiant
  AND ets.identreprise = a.identreprise
);


  /* \\\\\\\\\\\\\\\\\\\\\\\\ Création des trigers //////////////////////////  */
